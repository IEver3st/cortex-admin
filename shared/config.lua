...
Config.ActionPermissions = {
    ...
    ['player.setDefaultSavedPed'] = 'cortex-admin.appearance',
    ['player.randomizeMpFace'] = 'cortex-admin.appearance',
    ['player.clearPedTattoos'] = 'cortex-admin.appearance',
    ...
    ['dev.takePhoto'] = 'cortex-admin.recording',
    ['dev.openGallery'] = 'cortex-admin.recording',
    ['dev.startRecording'] = 'cortex-admin.recording',
    ['dev.stopRecording'] = 'cortex-admin.recording',
    ['dev.discardRecording'] = 'cortex-admin.recording',
    ['dev.openRockstarEditor'] = 'cortex-admin.recording',
    ['dev.freecam'] = 'cortex-admin.recording',
    ['options.quitSessionInRockstarEditor'] = 'cortex-admin.recording',
